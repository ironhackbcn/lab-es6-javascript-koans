...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      const findSome = argument => 'xyz'.includes(argument);
...
describe('destructuring objects. ', () => {
  ...
  describe('nested', () => {
    ...
    it('array and object', () => {
      const [num, [{ env,lang }]] = [null, [{env: 'browser', lang: 'ES6'}]];
...
describe('arrow functions. ', () => {
  ...
  class LexicallyBound {
    ...
    getArgumentsFunction() {
      return () => {return arguments}; // cause arguments exists in the conventional function local's scope
    }
  }
